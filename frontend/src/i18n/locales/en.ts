export default {
  ...
  keys: {
    ...
    accountShareConflict: {
      ...
      description: "Resolve its Account Plaza usage, reservations, and pending exits first to avoid interrupting requests or invalidating queue entries.",
      activeLabel: "In use",
      ...
      stepResolve: "End active usage, remove every queued reservation, and wait for pending exits to settle.",
