...
import { PAYMENT_MODE_QRCODE, PAYMENT_MODE_POPUP, PAYMENT_MODE_REDIRECT, PAYMENT_MODE_JSAPI } from './providerConfig'
...
const modeLabel = computed(() => {
  ...
  if (props.provider.payment_mode === PAYMENT_MODE_JSAPI) return t('admin.settings.payment.modeJSAPI')
  return ''
})
